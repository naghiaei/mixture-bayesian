...
This repository contains code and results for the paper "Bayesian Preference Estimation with Inconsistent Feedback," submitted to the DECISION Journal. More information can be found on our website:  [Website Link](https://naghiaei.github.io/mixture-bayesian/)
