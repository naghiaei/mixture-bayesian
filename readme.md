...
This repository contains code and results for the paper "Bayesian Preference Estimation with Inconsistent Feedback," submitted to the journal of Mathematical Psychology. More information can be found on our website:  [Website Linik](https://naghiaei.github.io/mixture-bayesian/)
